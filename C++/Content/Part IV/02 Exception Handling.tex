...
The C++ standard library provides a hierarchy of exception classes in \texttt{<stdexcept>}, all derived from \texttt{std::exception}. Examples include \texttt{std::runtime\_error}, \texttt{std::logic\_error}, \texttt{std::invalid\_argument}, and \texttt{std::out\_of\_range}. Using these standard exceptions can make your code more understandable to other developers.
