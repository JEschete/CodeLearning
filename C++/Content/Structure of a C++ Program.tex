...
\begin{itemize}
	...
	\item \textbf{Quotation marks ("" and '')} — define strings and characters
...
Or use the simpler (but non-standard) alternative:
...
\begin{itemize}
	\item \texttt{-o <n>} — Specify output file name
